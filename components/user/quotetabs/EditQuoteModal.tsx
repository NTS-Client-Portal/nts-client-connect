                ...
                <div className="flex-1 overflow-y-auto">
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                            ...
                            <button 
                                type="submit" 
                                className="px-6 py-3 bg-[#020a14] text-white rounded-lg hover:bg-[#0f172a] focus:ring-2 focus:ring-[#020a14] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium flex items-center gap-2"
                                disabled={isSubmitting}
                            >
                                {isSubmitting && (
